...
const themes = {
      ...
      MuiInputBase: {
        styleOverrides: {
          root: {
            ...
            color: '#E6E1E5',
            borderRadius: '16px',
            '& .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(197, 198, 201, 0.3)' },
            '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(197, 198, 201, 0.5)' },
            '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: '#9CE0FF' },
            '& input[type="date"]': { colorScheme: 'dark' },
          },
        },
      },
      MuiInputLabel: { styleOverrides: { root: { color: '#C9C5CD', '&.Mui-focused': { color: '#9CE0FF' }, '&.Mui-disabled': { color: '#938F99' } } } },
      MuiSelect: { styleOverrides: { select: { backgroundColor: '#4C4952', color: '#E6E1E5', borderRadius: '16px' }, icon: { color: '#E6E1E5' } } },
      MuiCheckbox: { styleOverrides: { root: { color: '#938F99', '&.Mui-checked': { color: '#9CE0FF' } } } },
      MuiRadio: { styleOverrides: { root: { color: '#938F99', '&.Mui-checked': { color: '#9CE0FF' } } } },
      MuiButton: {
        styleOverrides: {
          root: { borderRadius: '20px', textTransform: 'none', fontWeight: 500, padding: '3px 10px', boxShadow: 'none', '&:hover': { boxShadow: 'none' } },
          ...
          outlined: { borderColor: '#C9C5CD', color: '#C9C5CD', '&:hover': { borderColor: '#E6E1E5', color: '#E6E1E5', backgroundColor: 'rgba(230, 225, 229, 0.08)' } },
        },
      },
      MuiTab: { styleOverrides: { root: { textTransform: 'none', color: '#C9C5CD', '&.Mui-selected': { color: '#9CE0FF', fontWeight: 500 } } } },
      MuiDialog: { styleOverrides: { paper: { backgroundColor: '#36343B', backgroundImage: 'none', borderRadius: '28px', boxShadow: '0px 8px 16px rgba(0, 0, 0, 0.4)' } } },
      MuiDialogTitle: { styleOverrides: { root: { color: '#E6E1E5', fontWeight: 600 } } },
      MuiDialogContentText: { styleOverrides: { root: { color: '#C9C5CD' } } },
      MuiChip: {
        styleOverrides: {
          root: { color: '#FFFFFF', margin: '2px', borderRadius: '8px', fontWeight: 500, backgroundColor: 'rgba(156, 224, 255, 0.1)' },
  ...
  light: createTheme({
    ...
    components: {
        ...
        MuiSelect: { styleOverrides: { select: { backgroundColor: '#F5F5F5', color: '#212121', borderRadius: '16px' }, icon: { color: '#757575' } } },
        ...
        MuiDialog: { styleOverrides: { paper: { backgroundColor: '#FFFFFF', backgroundImage: 'none', borderRadius: '28px', boxShadow: '0px 8px 16px rgba(0, 0, 0, 0.2)' } } },
        MuiDialogTitle: { styleOverrides: { root: { color: '#212121', fontWeight: 600 } } },
        MuiDialogContentText: { styleOverrides: { root: { color: '#757575' } } },
        MuiChip: {
            styleOverrides: {
                root: { color: '#212121', margin: '2px', borderRadius: '8px', fontWeight: 500, backgroundColor: 'rgba(98, 0, 238, 0.1)' },
  ...
  ocean: createTheme({
    ...
    components: {
        ...
        MuiSelect: { styleOverrides: { select: { backgroundColor: 'rgba(30, 136, 229, 0.6)', color: '#E0F2F7', borderRadius: '12px' }, icon: { color: '#E0F2F7' } } },
        ...
        MuiButton: {
            styleOverrides: {
                root: { borderRadius: '16px', textTransform: 'none', fontWeight: 500, padding: '3px 10px', boxShadow: 'none', '&:hover': { boxShadow: 'none' } },
        ...
        MuiDialog: { styleOverrides: { paper: { backgroundColor: '#1565C0', backgroundImage: 'none', borderRadius: '20px', boxShadow: '0px 8px 16px rgba(0, 0, 0, 0.5)' } } },
  ...
  forest: createTheme({
    ...
    components: {
        ...
        MuiSelect: { styleOverrides: { select: { backgroundColor: 'rgba(95, 129, 142, 0.7)', color: '#F0F5F0', borderRadius: '14px' }, icon: { color: '#F0F5F0' } } },
        ...
        MuiButton: {
            styleOverrides: {
                root: { borderRadius: '18px', textTransform: 'none', fontWeight: 500, padding: '3px 10px', boxShadow: 'none', '&:hover': { boxShadow: 'none' } },
        ...
        MuiDialog: { styleOverrides: { paper: { backgroundColor: '#394A5D', backgroundImage: 'none', borderRadius: '24px', boxShadow: '0px 8px 16px rgba(0, 0, 0, 0.4)' } } },
        MuiDialogTitle: { styleOverrides: { root: { color: '#F0F5F0', fontWeight: 600 } } },
        MuiDialogContentText: { styleOverrides: { root: { color: '#D3DBE2' } } },
        MuiChip: {
            styleOverrides: {
                root: { color: '#FFFFFF', margin: '2px', borderRadius: '7px', fontWeight: 500, backgroundColor: 'rgba(168, 230, 207, 0.2)' },
                deleteIcon: { color: 'rgba(255, 255, 255, 0.7)', '&:hover': { color: 'rgba(255, 255, 255, 0.9)' } },
            },
        },
    },
...
function AppContent() { // Renamed App to AppContent
  ...
  const getWorkoutColor = useCallback((workoutName) => {
      switch (workoutName) {
          case 'Chest': return theme.palette.primary.light;
          case 'Biceps': return theme.palette.secondary.light;
          case 'Back': return theme.palette.mode === 'dark' ? '#D0BCFF' : '#424242'; // Adjust for light mode visibility
          ...
          case 'Other': return theme.palette.primary.main; // Fallback for 'Other' or any new types
          default: return theme.palette.primary.main;
      }
  }, [theme]); // Depend on theme

  // Utility function to get color for pain level chips
  const getPainLevelColor = useCallback((painLevel) => {
      ...
      if (level <= 6) return theme.palette.mode === 'dark' ? '#FFD180' : '#FFAB40'; // Adjust for light mode visibility
  ...
  const handleSubmit = (event) => {
    ...
    if (unitSystem === 'metric') {
      ...
      if (isNaN(feet) || isNaN(inches)) {
        showSimpleAlertDialog('Please enter valid values for both feet and inches.');
        return;
      }
  ...
  const handleConfirmUpdateExistingEntry = () => {
    const existingEntryIndex = fitnessEntries.findIndex(entry => entry.date === entryExistsDialogData.date);
    if (existingEntryIndex !== -1) {
  ...
  const getChartData = useCallback(() => {
    return fitnessEntries.map(entry => {
      const displayWeight = parseFloat(convertWeight(entry.weight, 'kg', unitSystem === 'metric' ? 'kg' : 'lbs').toFixed(1));
  ...
  const confirmDeleteCustomSupplement = () => {
    setCustomSupplements(prev => prev.filter(name => name !== supplementToDelete));
    ...
    <>
      ...
      <Container maxWidth="md" sx={{
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 2 }}>
            <Grid container spacing={3} direction="column">
              ...
              <Grid item xs={12}>
                ...
                <Paper elevation={3} sx={{ p: 3, mb: 3, backgroundColor: theme.palette.mode === 'dark' ? '#3A3740' : '#E0E0E0', borderRadius: '16px' }}>
            ...
            {chartData.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                ...
                >
                  ...
                  />
                  <Tooltip
                    contentStyle={{ backgroundColor: theme.palette.background.paper, border: `1px solid ${theme.palette.text.disabled}`, borderRadius: '8px' }}
                  ...
                  <Line yAxisId="left" type="monotone" dataKey="weight" name={`Weight (${unitSystem === 'metric' ? 'kg' : 'lbs'})`} stroke={theme.palette.primary.main} activeDot={{ r: 8 }} />
                  <Line yAxisId="right" type="monotone" dataKey="bmi" name="BMI" stroke={theme.palette.secondary.main} activeDot={{ r: 8 }} />
                </LineChart>
              </ResponsiveContainer>
            ) : (
                  ...
                  <Select
                    ...
                    renderValue={(selected) => (
                        selected ? (
                            <Chip
                                label={selected}
                                sx={{ backgroundColor: getWorkoutColor(selected), color: theme.palette.mode === 'dark' ? 'white' : 'black' }}
                            />
                        ) : (
        ...
        {currentTab === 3 && (
          <Box sx={{ mt: 2 }}>
            ...
            {entriesToDisplay.length === 0 ? (
              ...
              <List sx={{ '& > div': { mb: 2, p: 2, borderRadius: '16px', backgroundColor: theme.palette.mode === 'dark' ? '#3A3740' : '#E0E0E0' }, mt: 3 }}>
                {entriesToDisplay.map((entry, index) => {
                  ...
                  return (
                    <Paper key={index} elevation={2} sx={{ borderRadius: '16px', backgroundColor: theme.palette.background.paper }}>
            ...
            <List>
              {customSupplements.length === 0 ? (
                ...
                customSupplements.map((name, index) => (
                  <ListItem key={name} sx={{ bgcolor: theme.palette.background.default, mb: 1, borderRadius: '12px' }}>
        ...
        >
            ...
            <DialogActions>
                <Button onClick={cancelDeleteCustomSupplement} color="secondary" autoFocus>
                    Cancel
                </Button>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button onClick={handleConfirmUpdateExistingEntry} color="primary" autoFocus>
              Yes, Update
            </Button>
          </DialogActions>
        </Dialog>
        ...
        <Dialog
            ...
            fullWidth
        >
            <DialogTitle id="theme-dialog-title">Theme</DialogTitle> {/* Changed title to "Theme" */}
            <DialogContent>
